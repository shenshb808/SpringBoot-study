...
public class CodeGenerator {
    ...
    //作者
    private static final String AUTHOR = "沈涵博";
    //数据库schema
    private static final String URL = "jdbc:mysql://localhost:3306/shb_db?useUnicode=true&useSSL=false&characterEncoding=utf8";
    //数据库驱动
